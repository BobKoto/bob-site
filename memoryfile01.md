...
# Tech Notes: 
A casual memory and reflex challenge game for Android created in Java in with Android SDK.

Gameplay uses screen taps to replicate a random sequence of 6 symbols and their associated auditory tones, produced by the game, as fast as player can go.
